(function (global, factory) {
	...
	(global = global || self, factory(global.reacttiktok = {}, global.React));
	...
	*/
	...
	function TikTok(_a) {
	    ...
	    var _d = React.useState(undefined), scriptSrc = _d[0], setScriptSrc = _d[1];
	    var _e = React.useState(undefined), html = _e[0], setHTML = _e[1];
	    ...
	    React.useEffect(function () {
	        ...
	        var observer = new MutationObserver(function (mutationList) {
	            ...
	            var iframeAdded = mutationList.reduce(function (acc, curr) {
	                var iframe = Array.from(curr.addedNodes).find(function (node) { return node.nodeName === 'IFRAME'; });
	                if (iframe) {
	                    acc = iframe;
	                }
	                return acc;
	            ...
	            if (iframeAdded) {
	                iframeAdded.addEventListener('load', function () { return setLoaded(true); });
	            }
	        });
	        if (elem) {
	    ...
	    React.useEffect(function () {
	        fetchRetry$1(TIKTOK_OEMBED_BASE_URL + "?url=" + url)
	            ...
	            var htmlString = res.html;
	            var tempElement = document.createElement('div');
	            tempElement.innerHTML = htmlString;
	            var scriptTag = tempElement.getElementsByTagName('script')[0];
	    ...
	    return (React__default.createElement(React.Fragment, null,
	        React__default.createElement(HelmetExport, null,
	            React__default.createElement("script", { id: 'ttEmbedder', async: true, src: scriptSrc })),
	        React__default.createElement("div", { ref: ref, style: { display: loaded && html ? 'flex' : 'none' }, dangerouslySetInnerHTML: { __html: html || '' } })));
	}
