...
function TikTok(_a) {
    ...
    var _d = useState(undefined), scriptSrc = _d[0], setScriptSrc = _d[1];
    var _e = useState(undefined), html = _e[0], setHTML = _e[1];
    var ref = useRef(null);
    /**
    ...
    return (React.createElement(Fragment$1, null,
        React.createElement(HelmetExport, null,
            React.createElement("script", { id: 'ttEmbedder', async: true, src: scriptSrc })),
        React.createElement("div", { ref: ref, style: { display: loaded && html ? 'flex' : 'none' }, dangerouslySetInnerHTML: { __html: html || '' } })));
}
