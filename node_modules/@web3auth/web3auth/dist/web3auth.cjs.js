...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return defaultSolanaDappModalConfig; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return defaultEvmDappModalConfig; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return defaultSolanaWalletModalConfig; });
  ...
  constructor(options) {
    ...
    if (providedChainConfig.chainNamespace === base_["CHAIN_NAMESPACES"].SOLANA) {
      if (options.authMode === "WALLET") {
        ...
        this.modalConfig = config["d" /* defaultSolanaWalletModalConfig */];
      } else {
        // default config for solana dapp modal
        this.modalConfig = config["c" /* defaultSolanaDappModalConfig */];
      }
...
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "defaultSolanaDappModalConfig", function() { return _config__WEBPACK_IMPORTED_MODULE_0__["c"]; });
...
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "defaultSolanaWalletModalConfig", function() { return _config__WEBPACK_IMPORTED_MODULE_0__["d"]; });
